...
namespace MadPay724.Data.DatabaseContext
{
    public class Log_MadPayDbContext : DbContext
    {
        ...
        {
            optionBuilder
                .UseSqlServer(@"Server=localhost,1433;Database=Log_MadPayDbContext;User Id=SA;Password=aa#AA!123456aa;Trusted_Connection=False;MultipleActiveResultSets=True;");
        }
