...
namespace MadPay724.Presentation.Controllers.V1.Panel.Admin
{
    ...
    public class TicketsController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.AdminTicket.GetTickets)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpGet(SiteV1Routes.AdminTicket.GetTicket)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpPatch(SiteV1Routes.AdminTicket.SetTicketClosed)]
        ...
        //--------------------------------------------------------------------------------------------------------------------------------
        [Authorize(Policy = "RequireAdminRole")]
        [HttpGet(SiteV1Routes.AdminTicket.GetTicketContent, Name = "GetAdminTicketContent")]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpGet(SiteV1Routes.AdminTicket.GetTicketContents)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpPost(SiteV1Routes.AdminTicket.AddTicketContent)]
