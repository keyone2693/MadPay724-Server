...
namespace MadPay724.Presentation.Controllers.V1.Panel.Admin
{
    ...
    public class GatesController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.AdminGates.GetGates)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpPatch(SiteV1Routes.AdminGates.ChangeActiveGate)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpPatch(SiteV1Routes.AdminGates.ChangeDirectGate)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpPatch(SiteV1Routes.AdminGates.ChangeIpGate)]
