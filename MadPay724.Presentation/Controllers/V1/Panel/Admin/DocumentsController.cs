...
namespace MadPay724.Presentation.Controllers.V1.Panel.Admin
{
    ...
    public class DocumentsController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.AdminDocument.GetDocuments)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpGet(SiteV1Routes.AdminDocument.GetUserDocuments)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpGet(SiteV1Routes.AdminDocument.GetDocument)]
        ...
        [Authorize(Policy = "RequireAdminRole")]
        [HttpPut(SiteV1Routes.AdminDocument.UpdateDocument)]
