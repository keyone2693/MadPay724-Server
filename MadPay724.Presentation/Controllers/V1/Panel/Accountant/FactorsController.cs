...
namespace MadPay724.Presentation.Controllers.V1.Panel.Accountant
{
    ...
    public class FactorsController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.Factors.GetFactors)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Factors.GetWalletFactors)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Factors.GetGateFactors)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Factors.GetFactor, Name = "GetFactor")]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpPatch(SiteV1Routes.Factors.StatusFactor)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpPatch(SiteV1Routes.Factors.EditFactor)]
        ...
        [HttpDelete(SiteV1Routes.Factors.DeleteFactor)]
