...
namespace MadPay724.Presentation.Controllers.V1.Panel.Accountant
{
    ...
    public class EntryController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.Entry.GetApproveEntries)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Entry.GetPardakhtEntries)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Entry.GetDoneEntries)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Entry.GetBankCardEntries)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Entry.GetWalletEntries)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpGet(SiteV1Routes.Entry.GetEntry, Name = "GetEntry")]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpPatch(SiteV1Routes.Entry.UpdateEntry)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpPatch(SiteV1Routes.Entry.ApproveEntry)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpPatch(SiteV1Routes.Entry.PardakhtEntry)]
        ...
        [Authorize(Policy = "AccessAccounting")]
        [HttpPatch(SiteV1Routes.Entry.RejectEntry)]
        ...
        [HttpDelete(SiteV1Routes.Entry.DeleteEntry)]
