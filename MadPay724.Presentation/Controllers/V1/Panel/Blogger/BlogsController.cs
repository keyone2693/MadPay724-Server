...
namespace MadPay724.Presentation.Controllers.V1.Panel.Blogger
{
    [ApiVersion("1")]
    ...
    public class BlogsController : ControllerBase
    {
        ...
        [HttpPost(SiteV1Routes.Blog.UploadBlogImage)]
        ...
        [Authorize(Policy = "AccessBlog")]
        [HttpPost(SiteV1Routes.Blog.DeleteBlogImage)]
        ...
        [HttpGet(SiteV1Routes.Blog.GetBlogs)]
        ...
        [HttpGet(SiteV1Routes.Blog.GetBlog, Name = "GetBlog")]
        ...
        [Authorize(Policy = "AccessBlog")]
        [HttpPost(SiteV1Routes.Blog.AddBlog)]
        ...
        [Authorize(Policy = "AccessBlog")]
        [ServiceFilter(typeof(IsBloggerHimselfFilter))]
        [HttpPut(SiteV1Routes.Blog.UpdateBlog)]
        ...
        [HttpPut(SiteV1Routes.Blog.ApproveBlog)]
        ...
        [Authorize(Policy = "AccessAdminBlog")]
        [HttpPut(SiteV1Routes.Blog.SelectBlog)]
        ...
        [Authorize(Policy = "AccessAdminBlog")]
        [HttpDelete(SiteV1Routes.Blog.DeleteBlog)]
        ...
        [Authorize(Policy = "AccessAdminBlog")]
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpGet(SiteV1Routes.Blog.GetUnverifiedBlogCount)]
