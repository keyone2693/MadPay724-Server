...
namespace MadPay724.Presentation.Controllers.V1.Panel.Blogger
{
    ...
    public class BlogGroupsController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.BlogGroup.GetBlogGroups)]
        ...
        [Authorize(Policy = "AccessBlog")]
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpGet(SiteV1Routes.BlogGroup.GetBlogGroup, Name = "GetBlogGroup")]
        ...
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpPost(SiteV1Routes.BlogGroup.AddBlogGroup)]
        ...
        [Authorize(Policy = "AccessAdminBlog")]
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpPut(SiteV1Routes.BlogGroup.UpdateBlogGroup)]
        ...
        [Authorize(Policy = "AccessAdminBlog")]
        [HttpDelete(SiteV1Routes.BlogGroup.DeleteBlogGroup)]
