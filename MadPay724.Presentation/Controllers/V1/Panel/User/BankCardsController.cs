...
namespace MadPay724.Presentation.Controllers.V1.Panel.User
{
    ...
    public class BankCardsController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.BankCard.GetBankCards)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpGet(SiteV1Routes.BankCard.GetBankCard, Name = "GetBankCard")]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [HttpPost(SiteV1Routes.BankCard.AddBankCard)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [HttpPut(SiteV1Routes.BankCard.UpdateBankCard)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [HttpDelete(SiteV1Routes.BankCard.DeleteBankCard)]
