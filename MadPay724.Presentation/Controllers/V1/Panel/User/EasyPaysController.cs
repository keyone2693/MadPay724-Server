...
namespace MadPay724.Presentation.Controllers.V1.Panel.User
{
    ...
    public class EasyPaysController : ControllerBase
    {
        ...
        [HttpGet(SiteV1Routes.EasyPay.GetEasyPays)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpGet(SiteV1Routes.EasyPay.GetEasyPay, Name = "GetEasyPay")]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [ServiceFilter(typeof(UserCheckIdFilter))]
        [HttpGet(SiteV1Routes.EasyPay.GetEasyPayGatesWallets)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [HttpPost(SiteV1Routes.EasyPay.AddEasyPay)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [HttpPut(SiteV1Routes.EasyPay.UpdateEasyPay)]
        ...
        [Authorize(Policy = "RequireUserRole")]
        [HttpDelete(SiteV1Routes.EasyPay.DeleteEasyPay)]
