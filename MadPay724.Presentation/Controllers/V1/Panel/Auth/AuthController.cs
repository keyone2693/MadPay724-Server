...
namespace MadPay724.Presentation.Controllers.V1.Panel.Auth
{
    [ApiVersion("1")]
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost(SiteV1Routes.Auth.GetVerificationCode)]
        ...
        [HttpPost(SiteV1Routes.Auth.Register)]
        ...
        [HttpPost(SiteV1Routes.Auth.RegisterWithSocial)]
        [ProducesResponseType(typeof(ApiReturn<UserForDetailedDto>), StatusCodes.Status201Created)]
        [ProducesResponseType(typeof(ApiReturn<string>), StatusCodes.Status400BadRequest)]
        ...
        [HttpPost(SiteV1Routes.Auth.Login)]
